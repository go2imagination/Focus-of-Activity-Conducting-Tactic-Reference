...
<img src="requirement_calibration_thinking_model.png" alt="脑中协作模型" style="zoom:50%;"/>
...
对于大家耳熟能详的故事地图或其他用户故事可视化表现方式，主要就是在板砖需求这个级别进行梳理和结构化。（见参考2）
...
<img src="requirement_calibration_step7.png" alt="步骤7" style="zoom:50%;"/>
